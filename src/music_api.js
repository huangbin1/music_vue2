...
let toplist = [{
    ...
    name: '云音乐电音榜',
    url: 'http://music.163.com/discover/toplist?id=10520166',
    ...
    name: 'KTV嗨榜',
    url: 'http://music.163.com/discover/toplist?id=21845217',
    ...
    name: 'Hit FM Top榜',
    url: 'http://music.163.com/discover/toplist?id=120001',
...
const detail = (Vue = null, id = null, callback = null) => {
    let that = this
    Vue.$http.get("http://music.163.com/api/song/detail?id=" + id + "&ids=" + '%5B' + id + '%5D').then((response) => {
        // 响应成功回调
        callback && callback(response)
    }, (response) => {
        console.log('error response')
...
const lyric = (Vue = null, id = null, callback = null) => {
    let that = this
    Vue.$http.get("http://music.163.com/api/song/lyric?os=pc&id=" + id + '&lv=-1&kv=-1&tv=-1').then((response) => {
        // 响应成功回调
        callback && callback(response)
    }, (response) => {
        console.log('error response')
